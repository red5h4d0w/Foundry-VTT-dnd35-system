import {Actor35e} from "./actor/entity.js";
...
export const displayChatActionButtons = function(message, html, data) {
  const chatCard = html.find(".dnd35e.chat-card");
  ...
  options.push(
    {
      ...
      condition: canApply,
      callback: li => Actor35e.applyDamage(li, 1)
    },
    {
      name: "Apply Healing",
    ...
    },
    {
      ...
      condition: canApply,
      callback: li => Actor35e.applyDamage(li, 2)
    },
    {
      name: "Half Damage",
      icon: '<i class="fas fa-user-shield"></i>',
      condition: canApply,
      callback: li => Actor35e.applyDamage(li, 0.5)
    }
  );
  return options;
};